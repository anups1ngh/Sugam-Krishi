...
class _postItemPageState extends State<postItemPage> {
    ...
    try {
      if (_itemNameController.text.isEmpty && itemName.isEmpty) {
        ...
        res = await FireStoreMethods().uploadMarketplaceItem(
          ...
          category: category,
          file: _image,
          itemName: _itemNameController.text.isNotEmpty
              ? capitalizeFirst(_itemNameController.text)
  ...
  initState() {
    ...
    locationAdministrativeArea =
        LocationSystem.placemarks[0].administrativeArea.toString();
    super.initState();
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ToggleSwitch(
                        ...
                        labels: ['Sell', 'Rent'],
                        radiusStyle: true,
                        activeBgColor: (selltype == SELLTYPE.SELL)
                            ? [Colors.greenAccent.shade700]
                            : [Color.fromARGB(255, 239, 198, 90)],
  ...
  Widget sell() {
    ...
    final DropdownController dropdownController =
        DropdownController(duration: Duration(milliseconds: 200));
    final DropdownController sellUnitsDropdownController =
        DropdownController(duration: Duration(milliseconds: 200));
    void fillData() {
      for (String crop in SignupHandler.crops) {
        String cropName =
          ...
          children: [
            TextSpan(
              ...
              style: GoogleFonts.openSans(
                  fontSize: 14,
                  color: MyCropsHandler.cropsMap[itemName]?.bgColor),
            ),
          ],
        );
      } else {
        return TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: "Rs. $modal_price",
              style: GoogleFonts.openSans(
                  fontSize: 14, color: Colors.tealAccent.shade700),
            ),
            TextSpan(
              text: " per quintal",
            ),
  ...
  Widget rent() {
    ...
    final DropdownController rentUnitsDropdownController =
        DropdownController(duration: Duration(milliseconds: 200));
    return Padding(
      padding: const EdgeInsets.only(top: 15.0),
      child: Column(
