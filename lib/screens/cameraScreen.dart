        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  _launchURL(Uri.parse("https://www.google.com/search?q=" + diseaseName.replaceAll(" ", "+")));
                },
                child: Container(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      text: _output != null ? diseaseName : "Sorry, our model couldn't detect. Ask in the community",
                      style: GoogleFonts.poppins(
                  ...
                  FilledButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => chatScreen(initialQuery: diseaseName,)),
                      );
                    },
                  ),
                ],
